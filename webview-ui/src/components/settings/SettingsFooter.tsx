...
export const SettingsFooter = ({ version, className, ...props }: SettingsFooterProps) => (
	<div className={cn("text-vscode-descriptionForeground p-5", className)} {...props}>
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			...
			<VSCodeLink href="https://github.com/Blues-Org/bluescode" style={{ display: "inline" }}>
				github.com/Blues-Org/bluescode
			</VSCodeLink>{" "}
			or join{" "}
			<VSCodeLink href="https://www.reddit.com/r/BluesCode/" style={{ display: "inline" }}>
				reddit.com/r/BluesCode
			</VSCodeLink>
			.
		</p>
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			Regarding financial questions, please contact Customer Service at{" "}
			<VSCodeLink href="mail:hi@bluescode.ai" style={{ display: "inline" }}>
				hi@bluescode.ai
			</VSCodeLink>{" "}
		</p>
		<p className="italic">Blues Code v{version}</p>

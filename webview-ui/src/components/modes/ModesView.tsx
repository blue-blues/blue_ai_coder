...
import { ModeConfig, GroupEntry, PromptComponent, ToolGroup, modeConfigSchema } from "@blues-code/types"
...
import { TOOL_GROUPS } from "@blues/tools"
									...
									span: (
										<span
											...
											onClick={() => {
												...
												vscode.postMessage({
													type: "openFile",
													text: `./.bluescode/rules-${currentMode.slug}/rules.md`,
													values: {
														create: true,
														content: "",
													},
												...
												span: (
													<span
														...
														onClick={() => {
															...
															vscode.postMessage({
																type: "openFile",
																text: `./.bluescode/system-prompt-${currentMode.slug}`, // kilocode_change
																values: {
																	create: true,
																	content: "",
																},

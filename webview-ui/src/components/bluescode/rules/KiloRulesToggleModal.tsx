					...
					<Tooltip open={isVisible ? false : undefined}>
						<TooltipTrigger asChild>
							<BottomButton
								...
								ariaLabel={t("bluescode:rules.ariaLabel")}
								onClick={() => setIsVisible(!isVisible)}
							/>
						</TooltipTrigger>
						<TooltipContent>{t("bluescode:rules.tooltip")}</TooltipContent>
					</Tooltip>
				</TooltipProvider>
			</div>
			...
			{isVisible && (
				<div
					...
					<div
						...
						<div
							...
							<StyledTabButton $isActive={currentView === "rule"} onClick={() => setCurrentView("rule")}>
								{t("bluescode:rules.tabs.rules")}
							</StyledTabButton>
							<StyledTabButton
								$isActive={currentView === "workflow"}
								onClick={() => setCurrentView("workflow")}>
								{t("bluescode:rules.tabs.workflows")}
							</StyledTabButton>
						</div>
					</div>
					...
					<div className="text-xs text-[var(--vscode-descriptionForeground)] mb-4">
						{currentView === "rule" ? (
							<DescriptionWithLink
								href="https://bluescode.ai/docs/advanced-usage/custom-rules"
								linkText={t("bluescode:docs")}>
								{t("bluescode:rules.description.rules")}
							</DescriptionWithLink>
						) : (
							<DescriptionWithLink
								href="https://bluescode.ai/docs/features/slash-commands/workflows"
								linkText={t("bluescode:docs")}>
								{t("bluescode:rules.description.workflows")}{" "}
								<span className="text-[var(--vscode-foreground)] font-bold">/workflow-name</span>{" "}
								{t("bluescode:rules.description.workflowsInChat")}
							</DescriptionWithLink>
						)}
					</div>

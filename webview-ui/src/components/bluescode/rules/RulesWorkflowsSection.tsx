...
const RulesWorkflowsSection: React.FC<RulesWorkflowsSectionProps> = ({
	...
	const globalSectionKey =
		type === "rule" ? "bluescode:rules.sections.globalRules" : "bluescode:rules.sections.globalWorkflows"
	const workspaceSectionKey =
		type === "rule" ? "bluescode:rules.sections.workspaceRules" : "bluescode:rules.sections.workspaceWorkflows"

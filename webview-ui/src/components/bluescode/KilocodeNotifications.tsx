...
export const KilocodeNotifications: React.FC = () => {
	...
	useEffect(() => {
		const handleMessage = (event: MessageEvent) => {
			...
			if (message.type === "bluesCodeNotificationsResponse") {
	...
	useEffect(() => {
		vscode.postMessage({ type: "fetchBluesCodeNotifications" })
	}, [])
	...
	return (
		<div className="bluescode-notifications flex flex-col mb-4">

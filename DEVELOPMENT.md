# Blues Code Development Guide

Welcome to the Blues Code development guide! This document will help you set up your development environment and understand how to work with the codebase. Whether you're fixing bugs, adding features, or just exploring the code, this guide will get you started.
...
2. **Node.js** (version [v20.19.2](https://github.com/Blues-Org/bluescode/blob/main/.nvmrc) recommended)
...
1. **Fork and Clone the Repository**:
    ...
    - **Fork the Repository**:
        - Visit the [Blues Code GitHub repository](https://github.com/Blues-Org/bluescode)
        - Click the "Fork" button in the top-right corner to create your own copy.
    - **Clone Your Fork**:
        ```bash
        git clone https://github.com/[YOUR-USERNAME]/bluescode.git
        cd bluescode
        ```
...
The full list of recommended extensions is [here](https://github.com/Blues-Org/bluescode/blob/main/.vscode/extensions.json)
...
2. This will open a new VSCode window with Blues Code loaded
...
```bash
code --install-extension "$(ls -1v bin/blues-code-*.vsix | tail -n1)"
```
...
Blues Code uses several types of tests to ensure quality:
...
2.  **Type Generation**: Runs `pnpm --filter blues-code generate-types`.
...
- Check the Output panel in VSCode (View > Output) and select "Blues Code" from the dropdown
- For webview issues, use the browser developer tools in the webview (right-click > "Inspect Element")

## Contributing

We welcome contributions to Blues Code! Here's how you can help:

1. **Report an issue** using [GitHub Issues](https://github.com/Blues-Org/bluescode/issues)
2. **Find an issue** and submit a Pull Request with your fix
3. **Write tests** to improve Code Coverage
4. **Improve Documentation** at [bluescode.ai/docs](https://bluescode.ai/docs)
5. **Suggest a new feature** using [GitHub Discussions](https://github.com/Blues-Org/bluescode/discussions/categories/ideas)!

...
import { type ModelInfo, openAiModelInfoSaneDefaults, LMSTUDIO_DEFAULT_TEMPERATURE } from "@blues-code/types"
...
const LMSTUDIO_TIMEOUT_MS = 3_600_000 // bluescode_change
...
export class LmStudioHandler extends BaseProvider implements SingleCompletionHandler {
	...
	constructor(options: ApiHandlerOptions) {
		...
		this.client = new OpenAI({
			...
			apiKey: "noop",
			timeout: LMSTUDIO_TIMEOUT_MS, // bluescode_change
			fetch: fetchWithTimeout(LMSTUDIO_TIMEOUT_MS), // bluescode_change
		})
	}

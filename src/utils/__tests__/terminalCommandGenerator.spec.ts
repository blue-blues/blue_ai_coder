...
vi.mock("../../i18n", () => ({
	t: vi.fn((key: string, params?: any) => {
		const translations: Record<string, string> = {
			"bluescode:terminalCommandGenerator.inputPrompt": "Blues: Describe the command you want to generate",
			"bluescode:terminalCommandGenerator.inputPlaceholder":
				"e.g., kill the process running on port 3001, find large files, etc",
			"bluescode:terminalCommandGenerator.noActiveTerminal":
				"No active terminal found. Please open a terminal first.",
			"bluescode:terminalCommandGenerator.generatingProgress": "Generating terminal command...",
			"bluescode:terminalCommandGenerator.commandGenerated": `Generated command: ${params?.command || ""}`,
			"bluescode:terminalCommandGenerator.generationFailed": `Failed to generate command: ${params?.error || ""}`,
			"bluescode:terminalCommandGenerator.warningDialog.title": "Always Verify AI-Generated Commands",
			"bluescode:terminalCommandGenerator.warningDialog.message":
			...
			"bluescode:terminalCommandGenerator.warningDialog.okButton": "OK, I Understand",
			"bluescode:terminalCommandGenerator.warningDialog.cancelButton": "Cancel",
		}

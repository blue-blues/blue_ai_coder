...
import { getWorkspacePath } from "../../utils/path" // bluescode_change
...
export class Terminal extends BaseTerminal {
	...
	constructor(id: number, terminal: vscode.Terminal | undefined, cwd: string) {
		...
		this.terminal = terminal ?? vscode.window.createTerminal({ cwd, name: "Blues Code", iconPath, env })
	...
	public static getEnv(): Record<string, string> {
		const env: Record<string, string> = {
			...
			WORKSPACE_ROOT: getWorkspacePath(), // bluescode_change
		}

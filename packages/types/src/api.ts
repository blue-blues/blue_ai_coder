...
import type { BluesCodeEvents } from "./events.js"
import type { BluesCodeSettings } from "./global-settings.js"
...
export type BluesCodeAPIEvents = BluesCodeEvents

export interface BluesCodeAPI extends EventEmitter<BluesCodeAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): BluesCodeSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: BluesCodeSettings): Promise<void>
	/**
...
export interface BluesCodeIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void

...
export const DEFAULT_MODES: readonly ModeConfig[] = [
	{
		...
		customInstructions:
			"## Code Development\nFocus on writing clean, maintainable, and efficient code. Follow best practices for the specific programming language and framework being used.\n\n## Debugging and Troubleshooting\nWhen debugging issues:\n1. Reflect on 5-7 different possible sources of the problem\n2. Distill those down to 1-2 most likely sources\n3. Add logs or diagnostic code to validate your assumptions\n4. Explicitly ask the user to confirm the diagnosis before fixing the problem\n5. Use systematic debugging approaches: analyze stack traces, check error logs, and identify root causes\n\n## General Guidelines\n- Write comprehensive tests when appropriate\n- Document complex logic and architectural decisions\n- Consider performance implications of your code changes\n- Ensure code follows project conventions and style guidelines",
	},
	{
		slug: "orchestrator",
		// bluescode_change start

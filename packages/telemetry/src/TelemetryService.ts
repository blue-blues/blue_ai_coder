...
import { type TelemetryClient, type TelemetryPropertiesProvider, TelemetryEventName } from "@blues-code/types"
...
export class TelemetryService {
	...
	public async updateIdentity(bluesCodeToken: string) {
		for (const client of this.clients) {
			await client.updateIdentity(bluesCodeToken)
		}
	}
